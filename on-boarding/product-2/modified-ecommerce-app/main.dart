      ...
      case '4':
        ...
        try {
          ...
          updateProduct(Product(
            id: id,
            name: name?.isNotEmpty ?? false ? name! : existing.name,
            description: description?.isNotEmpty ?? false ? description! : existing.description,
            imageUrl: imageUrl?.isNotEmpty ?? false ? imageUrl! : existing.imageUrl,
            price: priceInput?.isNotEmpty ?? false ? double.parse(priceInput!) : existing.price,
          ));
